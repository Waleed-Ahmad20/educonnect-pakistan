...
const TutorSidebar = () => {
  ...
  const navItems = [
    ...
    { name: 'Sessions', path: '/tutor/sessions', icon: 'calendar' },
    { name: 'Earnings', path: '/tutor/earnings', icon: 'money' },
    { name: 'Availability', path: '/tutor/availability', icon: 'clock' },
  ];
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden sticky top-4">
      <div className="px-6 py-4 bg-primary-600 text-white">
        <h2 className="text-xl font-semibold">Tutor Portal</h2>
      </div>
      <nav className="py-2">
        <ul>
          {navItems.map((item) => (
